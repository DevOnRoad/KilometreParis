(function () {
  ...
  style.textContent = `
    ...
    #km-footer .footer-col li { margin-bottom: 0.5rem; }
    ...
    #km-footer .footer-col a:hover { color: #FFF8BD; }

    /* Paris sub-liens */
    #km-footer .footer-col .paris-sub {
      padding-left: 0.8rem;
    ...
    #km-footer .footer-col .paris-sub a {
      font-size: 0.68rem;
      color: rgba(255,255,255,0.35);
    }

    #km-footer .footer-col .paris-sub a:hover { color: #FFF8BD; }
